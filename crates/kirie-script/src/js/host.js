...
// CursorEvent payload for the cursor* module exports (d.ts: worldPosition and
// localPosition are Vec3; hitBox only exists for puppet-warp bones, which we
// don't simulate — left undefined, matching the d.ts optional).
globalThis.__cursorEvent = function (wx, wy, wz, lx, ly, lz) {
...
globalThis.__getLayerProp = function (id, name) {
  var l = __layerById(id);
